...
(`exam_id`, `student_id`, `student_name`, `start_time`, `time_allowed`, `end_time`, `score`)
VALUES (1, '2020501880', '小明', SUBTIME(NOW(), '13:50:00'), 120, SUBTIME(NOW(), '13:00:00'), 540),
       (1, '2020501826', '小红', SUBTIME(NOW(), '13:50:00'), 120, SUBTIME(NOW(), '12:40:00'), 840),
       (1, '2020501827', '小亮', SUBTIME(NOW(), '13:55:34'), 120, SUBTIME(NOW(), '12:40:00'), 912),
       (1, '2020501703', '小唐', SUBTIME(NOW(), '13:50:50'), 120, SUBTIME(NOW(), '12:01:26'), 705),
       (2, '2020501700', '小甲', SUBTIME(NOW(), '06:55:50'), 120, SUBTIME(NOW(), '05:01:00'), 405),
       (1, '2020501830', '小陆', SUBTIME(NOW(), '13:50:50'), 120, SUBTIME(NOW(), '12:01:26'), 905),
       (2, '2020501826', '小红', SUBTIME(NOW(), '06:45:30'), 120, SUBTIME(NOW(), '04:45:51'), 804),
       (2, '2020501703', '小唐', SUBTIME(NOW(), '06:07:00'), 120, SUBTIME(NOW(), '04:41:47'), 50),
       (2, '2018216386', '小阿', SUBTIME(NOW(), '05:45:03'), 120, SUBTIME(NOW(), '04:43:00'), 1000),
       (2, '2016664026', '小韩', SUBTIME(NOW(), '05:45:00'), 120, SUBTIME(NOW(), '05:00:00'), 0),
       -- only these two rows are referred by answers(`mcq_answer` and so on)
       (3, '2020501880', '小明', SUBTIME(NOW(), '01:26:00'), 90, NOW(), 0),
       (3, '2020501826', '小红', SUBTIME(NOW(), '01:20:00'), 90, NOW(), 0);
