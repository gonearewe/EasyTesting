...
type Maq struct {
	...
	Choice5            string `gorm:"column:choice_5;type:tinytext" json:"choice_5"`                                                                // 选项的内容
	Choice6            string `gorm:"column:choice_6;type:tinytext" json:"choice_6"`                                                                // 选项的内容
	Choice7            string `gorm:"column:choice_7;type:tinytext" json:"choice_7"`                                                                // 选项的内容
