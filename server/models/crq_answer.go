...
type CrqAnswer struct {
	...
	CrqID          int       `gorm:"uniqueIndex:crq_id;column:crq_id;type:int(10);not null" json:"crq_id"`                                         // 连接 crq
	ExamSessionID  int       `gorm:"uniqueIndex:crq_id;index:exam_session_id;column:exam_session_id;type:int(10);not null" json:"exam_session_id"` // 连接 exam_session
